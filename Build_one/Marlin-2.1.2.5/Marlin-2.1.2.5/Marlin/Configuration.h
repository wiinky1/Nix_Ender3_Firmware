...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 171.42
  #define DEFAULT_bedKi 29.76
  #define DEFAULT_bedKd 658.25
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -52.5, -2.89 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 250 }
